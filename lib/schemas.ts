...
export const SCHEMAS: Record<Exclude<FormType, "UNKNOWN">, FieldDef[]> = {
  ...
  "1099-SA": [
    { key: "payer_name", label: "Payer / Trustee name", type: "text", required: true },
    { key: "payer_tin", label: "Payer TIN", type: "ein", required: true },
    { key: "recipient_name", label: "Recipient name", type: "text", required: true },
    { key: "recipient_tin", label: "Recipient TIN", type: "ssn", required: true },
    { key: "box1_gross_distribution", label: "Box 1 — Gross distribution", type: "money", required: true },
    { key: "box2_earnings_excess", label: "Box 2 — Earnings on excess contributions", type: "money" },
    { key: "box3_distribution_code", label: "Box 3 — Distribution code", type: "code", required: true },
    { key: "box4_fmv_on_death", label: "Box 4 — FMV on date of death", type: "money" },
    { key: "account_type", label: "Box 5 — HSA / Archer MSA / MA MSA", type: "text", required: true },
    { key: "tax_year", label: "Tax year", type: "year", required: true },
  ],
  "1098": [
